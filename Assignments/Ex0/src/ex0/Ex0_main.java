...
public class Ex0_main {
    public static Long ID0 = 209132687L, ID1 = 314666611L, ID2 = null;
    ...
    public static void main(String[] ar) {
        ...
        //ElevatorAlgo ex0_alg = new ClassicElevator(Simulator_A.getBuilding());
        ElevatorAlgo ex0_alg = new MyAlgo(Simulator_A.getBuilding()); // TESTTTT
